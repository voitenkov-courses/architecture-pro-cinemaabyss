...
[x] MVP сервиса Events разработан.  
[x] Реализовано взаимодействие через Apache Kafka.  
...
[x] реализовать CI/CD для сборки прокси сервиса
[ ] реализовать необходимые конфигурационные файлы для переключения трафика.

### CI/CD

[x] сборка отработала и в github registry появятся ваши образы
[x] "зеленая" сборка и "зеленые" тесты
